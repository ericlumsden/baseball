...
plt.figure(5)
fig, ax = plt.subplots()
sc = ax.scatter(a_all_df[1], a_all_df[2], c=a_all_df['OPS'], cmap='magma')
...
plt.figure(6)
fig, ax = plt.subplots()
sc = ax.scatter(a_median_df[1], a_median_df[2], c=a_median_df['OPS'], cmap='magma')
fig.colorbar(sc, ax=ax)
ax.set_aspect('equal')
plt.title('projection - median')
plt.xlabel('p1')
...
plt.figure(7)
fig, ax = plt.subplots()
sc = ax.scatter(a_mean_df[1], a_mean_df[2], c=a_mean_df['OPS'], cmap='magma')
fig.colorbar(sc, ax=ax)
ax.set_aspect('equal')
plt.title('projection - median')
plt.xlabel('p1')
